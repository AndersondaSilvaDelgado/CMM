...
import br.com.usinasantafe.cmm.features.external.webservice.datasource.stable.*
import br.com.usinasantafe.cmm.features.infra.datasource.webservice.stable.*
import dagger.Binds
...
interface DatasourceWebServiceStableModule {
    ...
    @Singleton
    @Binds
    fun bindMotoMecDatasource(dataSource: OperMotoMecDatasourceWebServiceImpl): OperMotoMecDatasourceWebService
